...
public class MoreComparatorExamples {
    public static void main(String[] args) {
        ...
        //   }
        // }));
        employees.sort(Comparator.comparingInt(Employee::getSalary).thenComparing(Employee::getId));
        employees.forEach(System.out::println);
        ...
        Comparator<Employee> bySalaryThenFirstThenLast =
                Comparator.comparingInt(Employee::getSalary)
                        .thenComparing(emp -> emp.getName().getFirst())
                        .thenComparing(emp -> emp.getName().getLast());
